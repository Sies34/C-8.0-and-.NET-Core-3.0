...
namespace WritingFunctions
{
    class Program
    {
        ...
        static void RunCalculateTax()
        {
            ...
            {
                decimal taxToPay = CalculateTax(amount,region.ToUpper());
                WriteLine($"You must pay {region.ToUpper()} {taxToPay} in sales tax.");
            }
            else
            {
        ...
        /// <summary>
        /// Pass a 32-bit integer and it will be converted into its ordianl equivalant
        /// </summary>
